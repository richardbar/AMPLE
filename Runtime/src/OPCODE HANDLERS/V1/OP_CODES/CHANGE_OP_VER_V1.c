...
static bool CHANGE_OP_VER_NUM(FUNCTION_ARGUMENTS)
{
    return SET_OPCODE_VERSION(Arg1);
}

static bool CHANGE_OP_VER_REGISTER(FUNCTION_ARGUMENTS)
{
...
static bool CHANGE_OP_VER_MEMORY(FUNCTION_ARGUMENTS)
{
...
static bool (*CHANGE_OP_VER_MODES[])(ARGUMENT_TYPES) = {
        CHANGE_OP_VER_NUM,
