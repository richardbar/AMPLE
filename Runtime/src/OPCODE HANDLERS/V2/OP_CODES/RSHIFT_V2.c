...
static bool (*RSHIFT_MODES[])(ARGUMENT_TYPES) = {
    ...
    NULL,
    NULL,
    RSHIFT16_NUM_REGISTER_N,                                               // 0b0001010001
    RSHIFT16_REGISTER_REGISTER_N_N,                                        // 0b0001010010
    RSHIFT16_REGISTER_REGISTER_F_N,                                        // 0b0001010011
    RSHIFT16_MEMORY_REGISTER_N_N,                                          // 0b0001010100
    RSHIFT16_MEMORY_REGISTER_F_N,                                          // 0b0001010101
    NULL,
    NULL,
    NULL,
    RSHIFT16_NUM_REGISTER_F,                                               // 0b0001011001
    RSHIFT16_REGISTER_REGISTER_N_F,                                        // 0b0001011010
    RSHIFT16_REGISTER_REGISTER_F_F,                                        // 0b0001011011
    RSHIFT16_MEMORY_REGISTER_N_F,                                          // 0b0001011100
    RSHIFT16_MEMORY_REGISTER_F_F,                                          // 0b0001011101
    NULL,
    NULL,
    NULL,
    RSHIFT16_NUM_MEMORY_N,                                                 // 0b0001100001
    RSHIFT16_REGISTER_MEMORY_N_N,                                          // 0b0001100010
    RSHIFT16_REGISTER_MEMORY_F_N,                                          // 0b0001100011
    RSHIFT16_MEMORY_MEMORY_N_N,                                            // 0b0001100100
    RSHIFT16_MEMORY_MEMORY_F_N,                                            // 0b0001100101
    NULL,
    NULL,
    NULL,
    RSHIFT16_NUM_MEMORY_F,                                                 // 0b0001101001
    RSHIFT16_REGISTER_MEMORY_N_F,                                          // 0b0001101000
    RSHIFT16_REGISTER_MEMORY_F_F,                                          // 0b0001101011
    RSHIFT16_MEMORY_MEMORY_N_F,                                            // 0b0001101100
    ...
    NULL,
    NULL,
    RSHIFT32_NUM_REGISTER_N,                                               // 0b0010010001
    RSHIFT32_REGISTER_REGISTER_N_N,                                        // 0b0010010010
    RSHIFT32_REGISTER_REGISTER_F_N,                                        // 0b0010010011
    RSHIFT32_MEMORY_REGISTER_N_N,                                          // 0b0010010100
    RSHIFT32_MEMORY_REGISTER_F_N,                                          // 0b0010010101
    NULL,
    NULL,
    NULL,
    RSHIFT32_NUM_REGISTER_F,                                               // 0b0010011001
    RSHIFT32_REGISTER_REGISTER_N_F,                                        // 0b0010011010
    RSHIFT32_REGISTER_REGISTER_F_F,                                        // 0b0010011011
    RSHIFT32_MEMORY_REGISTER_N_F,                                          // 0b0010011100
    RSHIFT32_MEMORY_REGISTER_F_F,                                          // 0b0010011101
    NULL,
    NULL,
    NULL,
    RSHIFT32_NUM_MEMORY_N,                                                 // 0b0010100001
    RSHIFT32_REGISTER_MEMORY_N_N,                                          // 0b0010100010
    RSHIFT32_REGISTER_MEMORY_F_N,                                          // 0b0010100011
    RSHIFT32_MEMORY_MEMORY_N_N,                                            // 0b0010100100
    RSHIFT32_MEMORY_MEMORY_F_N,                                            // 0b0010100101
    NULL,
    NULL,
    NULL,
    RSHIFT32_NUM_MEMORY_F,                                                 // 0b0010101001
    RSHIFT32_REGISTER_MEMORY_N_F,                                          // 0b0010101000
    RSHIFT32_REGISTER_MEMORY_F_F,                                          // 0b0010101011
    RSHIFT32_MEMORY_MEMORY_N_F,                                            // 0b0010101100
    ...
    NULL,
    NULL,
    RSHIFT64_NUM_REGISTER_N,                                               // 0b0100010001
    RSHIFT64_REGISTER_REGISTER_N_N,                                        // 0b0100010010
    RSHIFT64_REGISTER_REGISTER_F_N,                                        // 0b0100010011
    RSHIFT64_MEMORY_REGISTER_N_N,                                          // 0b0100010100
    RSHIFT64_MEMORY_REGISTER_F_N,                                          // 0b0100010101
    NULL,
    NULL,
    NULL,
    RSHIFT64_NUM_REGISTER_F,                                               // 0b0100011001
    RSHIFT64_REGISTER_REGISTER_N_F,                                        // 0b0100011010
    RSHIFT64_REGISTER_REGISTER_F_F,                                        // 0b0100011011
    RSHIFT64_MEMORY_REGISTER_N_F,                                          // 0b0100011100
    RSHIFT64_MEMORY_REGISTER_F_F,                                          // 0b0100011101
    NULL,
    NULL,
    NULL,
    RSHIFT64_NUM_MEMORY_N,                                                 // 0b0100100001
    RSHIFT64_REGISTER_MEMORY_N_N,                                          // 0b0100100010
    RSHIFT64_REGISTER_MEMORY_F_N,                                          // 0b0100100011
    RSHIFT64_MEMORY_MEMORY_N_N,                                            // 0b0100100100
    RSHIFT64_MEMORY_MEMORY_F_N,                                            // 0b0100100101
    NULL,
    NULL,
    NULL,
    ...
    RSHIFT64_MEMORY_MEMORY_N_F,                                            // 0b0100101100
