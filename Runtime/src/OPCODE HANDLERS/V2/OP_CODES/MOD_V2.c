...
static bool (*MOD_MODES[])(ARGUMENT_TYPES) = {
        ...
        NULL,
        NULL,
        MOD16_NUM_REGISTER_N,                                               // 0b0001010001
        MOD16_REGISTER_REGISTER_N_N,                                        // 0b0001010010
        MOD16_REGISTER_REGISTER_F_N,                                        // 0b0001010011
        MOD16_MEMORY_REGISTER_N_N,                                          // 0b0001010100
        MOD16_MEMORY_REGISTER_F_N,                                          // 0b0001010101
        NULL,
        NULL,
        NULL,
        MOD16_NUM_REGISTER_F,                                               // 0b0001011001
        MOD16_REGISTER_REGISTER_N_F,                                        // 0b0001011010
        MOD16_REGISTER_REGISTER_F_F,                                        // 0b0001011011
        MOD16_MEMORY_REGISTER_N_F,                                          // 0b0001011100
        MOD16_MEMORY_REGISTER_F_F,                                          // 0b0001011101
        NULL,
        NULL,
        NULL,
        MOD16_NUM_MEMORY_N,                                                 // 0b0001100001
        MOD16_REGISTER_MEMORY_N_N,                                          // 0b0001100010
        MOD16_REGISTER_MEMORY_F_N,                                          // 0b0001100011
        MOD16_MEMORY_MEMORY_N_N,                                            // 0b0001100100
        MOD16_MEMORY_MEMORY_F_N,                                            // 0b0001100101
        NULL,
        NULL,
        NULL,
        MOD16_NUM_MEMORY_F,                                                 // 0b0001101001
        MOD16_REGISTER_MEMORY_N_F,                                          // 0b0001101000
        MOD16_REGISTER_MEMORY_F_F,                                          // 0b0001101011
        MOD16_MEMORY_MEMORY_N_F,                                            // 0b0001101100
        ...
        NULL,
        NULL,
        MOD32_NUM_REGISTER_N,                                               // 0b0010010001
        MOD32_REGISTER_REGISTER_N_N,                                        // 0b0010010010
        MOD32_REGISTER_REGISTER_F_N,                                        // 0b0010010011
        MOD32_MEMORY_REGISTER_N_N,                                          // 0b0010010100
        MOD32_MEMORY_REGISTER_F_N,                                          // 0b0010010101
        NULL,
        NULL,
        NULL,
        MOD32_NUM_REGISTER_F,                                               // 0b0010011001
        MOD32_REGISTER_REGISTER_N_F,                                        // 0b0010011010
        MOD32_REGISTER_REGISTER_F_F,                                        // 0b0010011011
        MOD32_MEMORY_REGISTER_N_F,                                          // 0b0010011100
        MOD32_MEMORY_REGISTER_F_F,                                          // 0b0010011101
        NULL,
        NULL,
        NULL,
        MOD32_NUM_MEMORY_N,                                                 // 0b0010100001
        MOD32_REGISTER_MEMORY_N_N,                                          // 0b0010100010
        MOD32_REGISTER_MEMORY_F_N,                                          // 0b0010100011
        MOD32_MEMORY_MEMORY_N_N,                                            // 0b0010100100
        MOD32_MEMORY_MEMORY_F_N,                                            // 0b0010100101
        NULL,
        NULL,
        NULL,
        MOD32_NUM_MEMORY_F,                                                 // 0b0010101001
        MOD32_REGISTER_MEMORY_N_F,                                          // 0b0010101000
        MOD32_REGISTER_MEMORY_F_F,                                          // 0b0010101011
        MOD32_MEMORY_MEMORY_N_F,                                            // 0b0010101100
        ...
        NULL,
        NULL,
        MOD64_NUM_REGISTER_N,                                               // 0b0100010001
        MOD64_REGISTER_REGISTER_N_N,                                        // 0b0100010010
        MOD64_REGISTER_REGISTER_F_N,                                        // 0b0100010011
        MOD64_MEMORY_REGISTER_N_N,                                          // 0b0100010100
        MOD64_MEMORY_REGISTER_F_N,                                          // 0b0100010101
        NULL,
        NULL,
        NULL,
        MOD64_NUM_REGISTER_F,                                               // 0b0100011001
        MOD64_REGISTER_REGISTER_N_F,                                        // 0b0100011010
        MOD64_REGISTER_REGISTER_F_F,                                        // 0b0100011011
        MOD64_MEMORY_REGISTER_N_F,                                          // 0b0100011100
        MOD64_MEMORY_REGISTER_F_F,                                          // 0b0100011101
        NULL,
        NULL,
        NULL,
        MOD64_NUM_MEMORY_N,                                                 // 0b0100100001
        MOD64_REGISTER_MEMORY_N_N,                                          // 0b0100100010
        MOD64_REGISTER_MEMORY_F_N,                                          // 0b0100100011
        MOD64_MEMORY_MEMORY_N_N,                                            // 0b0100100100
        MOD64_MEMORY_MEMORY_F_N,                                            // 0b0100100101
        NULL,
        NULL,
        NULL,
        ...
        MOD64_MEMORY_MEMORY_N_F,                                            // 0b0100101100
